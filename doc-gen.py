...
def server(input: Inputs, output: Outputs, session: Session):
    ...
    def download_word():
        content = input.editable_ai_result() or ai_output_result_value()

        if not content or content == "等待AI处理...":
            content = "# 项目简报\n\n暂无AI输出内容，请先点击“开始解析+结构化”。"

        yield markdown_to_docx_bytes(content)
